...
int main (int argc, char *argv[])
{
    ...
    printf("                            |                                                          |\n");
    printf("                            |                                                          |\n");
    printf("                            |               PARTIE CONTRE IA TAPER 1                   |\n");
    printf("                            |                                                          |\n");
    printf("                            |                                                          |\n");
    ...
    printf("                             ----------------------------------------------------------                         \n");
    printf("                             -----------------------------------------------------------                         \n");
    printf("                            | realise par : KORCHI MOHAMMED AMINE et AITOUHAMANE ILYASS |\n");
    printf("                             -----------------------------------------------------------                         \n");
    scanf("%d",&c);
    system("cls");
    if (c == 1) {
    ...
    printf("                            |                                                          |\n");
    printf("                            |                                                          |\n");
    printf("                            |        JOUER CONTRE L'IA ( NIVEAU FACILE ) TAPER 1       |\n");
    printf("                            |                                                          |\n");
    printf("                            |                                                          |\n");
    printf("                            |        JOUER CONTRE L'IA ( NIVEAU MOYEN )  TAPER 1       |\n");
    printf("                            |                                                          |\n");
    printf("                            |                                                          |\n");
    printf("                            |                   QUITTER TAPER 0                        |\n");
    printf("                            |                                                          |\n");
    ...
    printf("                            |                                                          |\n");
    printf("                            |                                                          |\n");
    printf("                            |        JOUER CONTRE L'IA ( MODE NORMALE ) TAPER 1        |\n");
    printf("                            |                                                          |\n");
    printf("                            |                                                          |\n");
    printf("                            |        JOUER CONTRE L'IA ( MODE INVERSE ) TAPER 2        |\n");
    printf("                            |                                                          |\n");
    printf("                            |                                                          |\n");
    printf("                            |                   QUITTER TAPER 0                        |\n");
    printf("                            |                                                          |\n");
    ...
    printf("\n");
    printf("                             -----------------------------------------------------------                         \n");
    printf("                            |     PLAYER 1 TAPER LE PION QUE VOUS VOULEZ POUR IA        |                       \n");
    printf("                             -----------------------------------------------------------                         \n");
    scanf("%s",ss);
    system("cls");
    m1 = bb[0];
